...
export default {
      ...
      teamMembers: [
        {
          ...
          linkedin: 'https://www.linkedin.com/in/ayelet-moyal-36748720b/',
  ...
  methods: {
    openModal() {
      var myModal = new Modal(document.getElementById('contactModal'));
      myModal.show();
    }
  }
};
...
.role {
  ...
  margin-top: -10px; /* Adjust margin to position the role closer to the name */
}
